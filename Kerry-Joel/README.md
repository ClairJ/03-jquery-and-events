...
Creating navigation options for the user to select an author name or category to filter the article content.
## Getting Started
<!-- What are the steps that a user must take in order to build this app on their own machine and get it running? -->
The user must know template literal notation, event-handlers, event-listeners, and JQuery methods.
## Architecture
...
10.26.2017 01:38pm - Still hashing out template notation and event handler to reveal hidden portions to our articles
10.26.2017 12:30pm - Added category selection functionality and cleared opposiing selector when either one chosen
10.26.2017 11:30am - article.js todo finished
-->
```
